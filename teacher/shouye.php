...
require_once("../api/user.php");
echo "用户名：";
echo $_COOKIE["teacher_username"];
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
echo "姓名：";
echo teacher_info_name($_COOKIE["teacher_username"]);
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
?>
<script type="text/javascript">
function signout(){
    if(window.confirm("确定要退出登录吗？")){
    document.cookie = "teacher_username=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/teacher;";
    document.cookie = "teacher_password=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/teacher;";
